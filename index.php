    ...
    switch ($_GET['act']) {
        ...
        case'thanhtoan':
            if((isset($_POST['thanhtoan']))&&($_POST['thanhtoan'])){
                ...
                $tel=$_POST['tel'];
                $pttt=$_POST['pttt'];
                $ma_dh="PHATKS".rand(0,999999);
                //tao don hang
                //va tra ve mot id don hang
                $iddh=taodonhang($ma_dh,$tongdonhang,$pttt,$hoten,$address,$email,$tel);

                $_SESSION['iddh']=$iddh;
                if(isset($_SESSION['giohang'])&&(count($_SESSION)>0)){
                    foreach ($_SESSION['giohang'] as $item) {
                        // addtocart($iddh, $idpro,$tensp,$img,$dongia,$soluong)
                        // addtocart($iddh, $item[0],$item[1],$item[2],$item[3],$item[4]);
                        addtodetail($iddh,$item[0],$item[4]);
                    }
